...
if aperture == 0
    round(aperture_radius./pixel_size)
...
%         drawnow
        ...
        figure(33); img(big_obj, ['ePIE ', num2str(itt)], 'colormap', 'gray');
        figure(34); imagesc(hsv_ap); axis image; colormap('gray'), title(num2str(itt));
        drawnow          
    end
